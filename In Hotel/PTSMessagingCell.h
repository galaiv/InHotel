...
@interface PTSMessagingCell : UITableViewCell {
    ...
    UIImageView* avatarImageView,*videoImg,*drinkImg,*drinkBgImg;
    UIButton *playBtn,*acceptBtn,*rejectBtn;
    
    /*Subview of the MessaginCell, containing the timestamp (if specified). It can be set in the cellForRowAtIndexPath:-Method.*/
    UILabel* timeLabel;
    UILabel* nameLabel,*drinkLabel;
...
@property (nonatomic, readonly) UILabel * nameLabel,*drinkLabel;

@property (nonatomic, readonly) UIImageView * avatarImageView,*videoImg,*drinkImg,*drinkBgImg;

@property (nonatomic, readonly) UIImageView * balloonView;

@property (assign) BOOL sent,msg_video,msg_drink;

@property (nonatomic, readonly) UIButton *playBtn,*acceptBtn,*rejectBtn;
